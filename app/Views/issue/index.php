                                 ...
                                 <form method="post" id="add_issue_form">
                                    ...
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          ...
                                          <div class="row">
                                             <div class="col-md-6">
                                                <div class="mb-3">
                                                   ...
                                                   <input type="text" id="issue_uid" name="issue_uid" class="form-control" readonly>
                                          ...
                                          <div class="form-group mt-2">
                                             <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" value="<?php echo date('Y-m-d'); ?>" id="issue_due_date" name="issue_due_date">
                                       ...
                                       <div class="modal-footer">
                                          <input type="hidden" name="issue_book_id" id="issue_book_id" value="">
...
<script>
   ...
   $(document).ready(function() {
         ...
         $.ajax({
            ...
            success: function(res) {
               ...
               if (res.error) {
                  ...
                  if (res.error.error_issue_book_title) {
                     $('#error_issue_book_title').text(res.error.error_issue_book_title)
                     $('#issue_book_title').addClass('is-invalid')
                  } else {
                     $('#error_issue_book_title').text('')
                     $('#issue_book_title').removeClass('is-invalid');
                  }
                  if (res.error.error_issue_book_id) {
                     $('#error_issue_book_id').text(res.error.error_issue_book_id)
                     $('#issue_book_uid').addClass('is-invalid')
                  } else {
                     $('#error_issue_book_id').text('')
                     $('#issue_book_uid').removeClass('is-invalid');
                  }
                  if (res.error.error_issue_isbn) {
                     $('#error_issue_isbn').text(res.error.error_issue_isbn)
                     $('#issue_book_isbn').addClass('is-invalid')
                  } else {
                     $('#error_issue_isbn').text('')
                     $('#issue_book_isbn').removeClass('is-invalid');
                  }
      ...
      $(document).on('click', '.edit_return', function() {
         const id = $(this).attr('issue_id')

         const book_id = $(this).attr('data-book')

         var issue_id = $(this).attr('id');
         $.ajax({
            url: "<?= base_url('issue/book_return') ?>",
            type: "post",
            data: {
               issue_id: issue_id,
               book_id: book_id
